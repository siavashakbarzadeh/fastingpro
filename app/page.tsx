    ...
    <main className="min-h-screen bg-slate-50 flex flex-col items-center justify-center p-6">
      ...
      {currentStep === 0 && (
        <button
          ...
          className="mt-8 flex items-center gap-3 bg-white px-6 py-3 rounded-full shadow-xl shadow-blue-500/5 text-slate-600 font-bold hover:bg-slate-50 transition-all hover:scale-105 active:scale-95 border border-slate-100"
        >
